...
#include <highlevel/KlogStorageEntity.edl.h>
#include <kss/audit.h>
...
static int _read_range(
  [[maybe_unused]] struct MyContext *ctx, 
  [[maybe_unused]] nk_uint64_t first_id, 
  [[maybe_unused]] nk_uint64_t last_id, 
  [[maybe_unused]] struct kl_KlogStorage_Entry *entries)
{
  return 0;
}
  ...
  [[maybe_unused]] char *argv[])
{
  ...
  return klog_storage_run(KLOG_STORAGE_SERVER_CONNECTION_ID, highlevel_KlogStorageEntity_klogStorage_iidOffset, highlevel_KlogStorageEntity_klogStorage_storage_iid, comp);
}